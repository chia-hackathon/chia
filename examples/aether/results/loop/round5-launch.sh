...
{
echo "# round5 launched $(date -Is)  (all --seed best, --budget-usd 1000)"
} >> out/loop/round5-runs.txt
launch() {
  kern=$1; iters=$2
  log="$BASE/out/loop/round5-$kern.log"
...
launch llama-q8-gemv-gemmini-n16 10
